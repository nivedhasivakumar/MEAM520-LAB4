...
%% Current limits
lowerCurrentLim = [-1.2, -6, -1.8, -2.5, -1.2, -0.8];
upperCurrentLim = [1.2, 6, 1.8, 2.5, 1.2, 0.8];
...
pwm = (voltages/4 + 2.5)*255/5; %DEFINITELY CHANGE (127 is zero voltage.  The rest depends on the resistors used in the circuit.  Nominal is 0-255 => -10 to 10 V
