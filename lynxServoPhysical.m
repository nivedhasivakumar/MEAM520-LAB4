...
P1 = q(1) * (180/pi/0.102) + servoOffsets(1);
P2 = q(2) * (180/pi/0.105) + servoOffsets(2);
P3 = q(3) * (180/pi/0.109) + servoOffsets(3);
P4 = q(4) * (180/pi/0.095) + servoOffsets(4);
P5 = q(5) * (180/pi/0.102) + servoOffsets(5);
P6 = q(6) / -0.028 + servoOffsets(6);
