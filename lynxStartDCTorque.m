function lynxStartDCTorque(varargin)
...
% Lynx ADL5 constants in inches
a = 3; % base height
b = 5.75; % shoulder to elbow length
c = 7.375; %elbow to wrist length
d = 1.75; %wrist1 to wrist2
e = 1.25; %wrist2 to base of gripper
f = 1.125; % gripper length
