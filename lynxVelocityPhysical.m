...
% Commands the real Lynx robot to the joint angular velocities defined by the input (in radians/s)
% Has the same limits as lynxServo.m

% INPUTS:
%   om1...om5,gripV : Velocities of joints for the six DOF Lynx arm
